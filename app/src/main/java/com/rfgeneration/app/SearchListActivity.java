...
import com.rfgeneration.app.scrapers.SearchScraper;
                    ...
                    if (position < collectionGames.size()) {
                    	...
                    	for (int i = 0; i < o.getCollections().size(); i++) {
	    			    	...
	    			    	folderQty.setText(Html.fromHtml("<font color=\"#" + Integer.toHexString(getResources().getColor(R.color.qty)).substring(2) + "\">" +
	    			    			"G:" + Collection.getQuantityString(o.getCollections().get(i).getGameQuantity()) + "</font> <font color=\"#" + Integer.toHexString(getResources().getColor(R.color.box)).substring(2) + "\">" +
	    			    			"B:" + Collection.getQuantityString(o.getCollections().get(i).getBoxQuantity()) + "</font> <font color=\"#" + Integer.toHexString(getResources().getColor(R.color.man)).substring(2) + "\">" +
